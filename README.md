...
Значение 49923 наноТесла переводим в Гауссы из соотношения 1 Тесла = 10 000 Гаусс. Получим общую напряженнность равную 0,49923 Гаусс. Окончательно 0,49923 умножаем на 6842 это множитель чувствительности сенсора для перевода из Гауссов в RAW единицы. 
...
```python
calibration_matrix = [[0.969610, -0.003678, -0.008349],
                      [-0.003678, 0.981015, 0.003418],
                      [-0.008349, 0.003418, 0.979776]]

bias = [0.230693, -0.285273, 0.539399]
```
