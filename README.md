...
Для вычисления этих параметров существуют различные методики. В нашем методе, мы соберем облако значений в файл и зате с помощью программы magneto вычислим калибровочные параметры.
Скачайть программу можно по адресу тут [https://sites.google.com/site/sailboatinstruments1/home](https://sites.google.com/site/sailboatinstruments1/home)
